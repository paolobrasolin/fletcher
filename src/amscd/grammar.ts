...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "label", "symbols": ["label$macrocall$1"]},
    {"name": "empty_arrow$string$1", "symbols": [{"literal":"@"}, {"literal":"."}], "postprocess": (d) => d.join('')},
    {"name": "empty_arrow", "symbols": ["empty_arrow$string$1"]},
    {"name": "horizontal_equals$string$1", "symbols": [{"literal":"@"}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "horizontal_equals", "symbols": ["horizontal_equals$string$1"]},
    {"name": "vertical_equals$string$1", "symbols": [{"literal":"@"}, {"literal":"|"}], "postprocess": (d) => d.join('')},
    {"name": "vertical_equals", "symbols": ["vertical_equals$string$1"]},
    {"name": "vertical_equals$string$2", "symbols": [{"literal":"@"}, {"literal":"\\"}, {"literal":"v"}, {"literal":"e"}, {"literal":"r"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "vertical_equals", "symbols": ["vertical_equals$string$2"]},
    ...
    {"name": "up_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "up_arrow$macrocall$2", "up_arrow$macrocall$1$ebnf$1", "up_arrow$macrocall$2", "up_arrow$macrocall$1$ebnf$2", "up_arrow$macrocall$2"]},
    {"name": "up_arrow", "symbols": ["up_arrow$macrocall$1"]},
    ...
    {"name": "down_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "down_arrow$macrocall$2", "down_arrow$macrocall$1$ebnf$1", "down_arrow$macrocall$2", "down_arrow$macrocall$1$ebnf$2", "down_arrow$macrocall$2"]},
    {"name": "down_arrow", "symbols": ["down_arrow$macrocall$1"]},
    ...
    {"name": "left_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "left_arrow$macrocall$2", "left_arrow$macrocall$1$ebnf$1", "left_arrow$macrocall$2", "left_arrow$macrocall$1$ebnf$2", "left_arrow$macrocall$2"]},
    {"name": "left_arrow", "symbols": ["left_arrow$macrocall$1"]},
    ...
    {"name": "left_arrow$macrocall$4", "symbols": [{"literal":"@"}, "_", "left_arrow$macrocall$5", "left_arrow$macrocall$4$ebnf$1", "left_arrow$macrocall$5", "left_arrow$macrocall$4$ebnf$2", "left_arrow$macrocall$5"]},
    {"name": "left_arrow", "symbols": ["left_arrow$macrocall$4"]},
    ...
    {"name": "right_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "right_arrow$macrocall$2", "right_arrow$macrocall$1$ebnf$1", "right_arrow$macrocall$2", "right_arrow$macrocall$1$ebnf$2", "right_arrow$macrocall$2"]},
    {"name": "right_arrow", "symbols": ["right_arrow$macrocall$1"]},
    ...
    {"name": "right_arrow$macrocall$4", "symbols": [{"literal":"@"}, "_", "right_arrow$macrocall$5", "right_arrow$macrocall$4$ebnf$1", "right_arrow$macrocall$5", "right_arrow$macrocall$4$ebnf$2", "right_arrow$macrocall$5"]},
    {"name": "right_arrow", "symbols": ["right_arrow$macrocall$4"]},
    {"name": "node", "symbols": ["label"]},
    {"name": "horizontal_edge", "symbols": ["empty_arrow"]},
    {"name": "horizontal_edge", "symbols": ["horizontal_equals"]},
    {"name": "horizontal_edge", "symbols": ["left_arrow"]},
    {"name": "horizontal_edge", "symbols": ["right_arrow"]},
    {"name": "vertical_edge", "symbols": ["empty_arrow"]},
    {"name": "vertical_edge", "symbols": ["vertical_equals"]},
    {"name": "vertical_edge", "symbols": ["up_arrow"]},
    {"name": "vertical_edge", "symbols": ["down_arrow"]},
    ...
    {"name": "odd_row", "symbols": ["node", "odd_row$ebnf$1"]},
    {"name": "even_row$ebnf$1", "symbols": []},
    {"name": "even_row$ebnf$1$subexpression$1", "symbols": ["_", "vertical_edge"]},
    {"name": "even_row$ebnf$1", "symbols": ["even_row$ebnf$1", "even_row$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "even_row", "symbols": ["_", "vertical_edge", "even_row$ebnf$1", "_"]},
    {"name": "matrix$ebnf$1", "symbols": []},
    {"name": "matrix$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"\\"}, {"literal":"\\"}], "postprocess": (d) => d.join('')},
    {"name": "matrix$ebnf$1$subexpression$1$string$2", "symbols": [{"literal":"\\"}, {"literal":"\\"}], "postprocess": (d) => d.join('')},
    {"name": "matrix$ebnf$1$subexpression$1", "symbols": ["matrix$ebnf$1$subexpression$1$string$1", "even_row", "matrix$ebnf$1$subexpression$1$string$2", "odd_row"]},
    {"name": "matrix$ebnf$1", "symbols": ["matrix$ebnf$1", "matrix$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "matrix", "symbols": ["odd_row", "matrix$ebnf$1"]},
    ...
    {"name": "main", "symbols": ["main$string$1", "matrix", "main$string$2"]}
  ],
  ParserStart: "_",
};
