...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "empty_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "empty_arrow$macrocall$2"], "postprocess": (d) => [d[2][0]]},
    {"name": "empty_arrow", "symbols": ["empty_arrow$macrocall$1"], "postprocess": id},
    {"name": "horizontal_equals$macrocall$2", "symbols": [{"literal":"="}]},
    {"name": "horizontal_equals$macrocall$1", "symbols": [{"literal":"@"}, "_", "horizontal_equals$macrocall$2"], "postprocess": (d) => [d[2][0]]},
    ...
    {"name": "vertical_equals$macrocall$1", "symbols": [{"literal":"@"}, "_", "vertical_equals$macrocall$2"], "postprocess": (d) => [d[2][0]]},
    ...
    {"name": "vertical_equals$macrocall$3", "symbols": [{"literal":"@"}, "_", "vertical_equals$macrocall$4"], "postprocess": (d) => [d[2][0]]},
    ...
    {"name": "up_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "up_arrow$macrocall$2", "up_arrow$macrocall$1$ebnf$1", "up_arrow$macrocall$2", "up_arrow$macrocall$1$ebnf$2", "up_arrow$macrocall$2"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
    ...
    {"name": "down_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "down_arrow$macrocall$2", "down_arrow$macrocall$1$ebnf$1", "down_arrow$macrocall$2", "down_arrow$macrocall$1$ebnf$2", "down_arrow$macrocall$2"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
    ...
    {"name": "left_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "left_arrow$macrocall$2", "left_arrow$macrocall$1$ebnf$1", "left_arrow$macrocall$2", "left_arrow$macrocall$1$ebnf$2", "left_arrow$macrocall$2"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
    ...
    {"name": "left_arrow$macrocall$4", "symbols": [{"literal":"@"}, "_", "left_arrow$macrocall$5", "left_arrow$macrocall$4$ebnf$1", "left_arrow$macrocall$5", "left_arrow$macrocall$4$ebnf$2", "left_arrow$macrocall$5"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
    ...
    {"name": "right_arrow$macrocall$1", "symbols": [{"literal":"@"}, "_", "right_arrow$macrocall$2", "right_arrow$macrocall$1$ebnf$1", "right_arrow$macrocall$2", "right_arrow$macrocall$1$ebnf$2", "right_arrow$macrocall$2"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
    ...
    {"name": "right_arrow$macrocall$4", "symbols": [{"literal":"@"}, "_", "right_arrow$macrocall$5", "right_arrow$macrocall$4$ebnf$1", "right_arrow$macrocall$5", "right_arrow$macrocall$4$ebnf$2", "right_arrow$macrocall$5"], "postprocess": (d) => [d[2][0], squish(deepJoin(d[3])), squish(deepJoin(d[5]))]},
